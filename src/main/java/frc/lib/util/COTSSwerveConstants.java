...
public class COTSSwerveConstants {
    ...
    public COTSSwerveConstants(double wheelDiameter, double angleGearRatio, double driveGearRatio, boolean driveMotorInvert, boolean angleMotorInvert, boolean canCoderInvert){
    ...
    public static COTSSwerveConstants SDSMK4i(double driveGearRatio){
        ...
        /** 1 : (150 / 7) */
        double angleGearRatio = (1.0 / (150.0 / 7.0));

        boolean driveMotorInvert = false;
        boolean angleMotorInvert = false;
        boolean canCoderInvert = false;
        return new COTSSwerveConstants(wheelDiameter, angleGearRatio, driveGearRatio, driveMotorInvert, angleMotorInvert, canCoderInvert);
    }
